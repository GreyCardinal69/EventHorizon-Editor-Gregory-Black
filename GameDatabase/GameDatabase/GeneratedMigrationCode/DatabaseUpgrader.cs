...
namespace DatabaseMigration
{
    ...
    public partial class DatabaseUpgrader
    {
        ...
        {
            int major = _storage.Version.Major;
            int minor = _storage.Version.Minor;
            ...
            if (major <= 1)
            {
                ...
                v1.DatabaseUpgrader upgrader = new v1.DatabaseUpgrader(content1);
    ...
    namespace v1
    {
        public partial class DatabaseUpgrader
        {
            ...
            {
                Content = content;
                int major = content.VersionMajor;
                int minor = content.VersionMinor;
