...
namespace EditorDatabase.DataModel
{
    public partial class StatModification
    {
        ...
        public StatModification(StatModificationSerializable serializable, Database database)
        {
        ...
        {
            StatModificationSerializable serializable = new StatModificationSerializable();
        ...
        public static StatModification DefaultValue { get; set; }
    }
}
