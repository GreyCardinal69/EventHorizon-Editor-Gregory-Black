...
namespace GameDatabase
{
    partial class ShipEditorDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.layoutSize.Maximum = new decimal(new int[] {1024, 0, 0, 0});
            this.layoutSize.Minimum = new decimal(new int[] {1, 0, 0, 0});
            this.layoutSize.Name = "layoutSize";
            this.layoutSize.Size = new System.Drawing.Size(85, 34);
            this.layoutSize.TabIndex = 4;
            this.layoutSize.Value = new decimal(new int[] {1, 0, 0, 0});
